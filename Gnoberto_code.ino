...
//Funciòn que agrega los datos de lectura a la base de datos
void Load_DHT11_Data() {
  //-----------------------------------------------------------
  temperatura = dht11.readTemperature(); //Celsius
  humedad = dht11.readHumidity(); //Porcentaje
  //-----------------------------------------------------------
  // Revisa si alguna lectura tuvo error
